...
/* harmony export */   getCurrentTabUrl: () => (/* binding */ getCurrentTabUrl),
/* harmony export */   getSavedBackgroundColor: () => (/* binding */ getSavedBackgroundColor),
/* harmony export */   saveBackgroundColor: () => (/* binding */ saveBackgroundColor),
/* harmony export */   setDefaultColor: () => (/* binding */ setDefaultColor)
/* harmony export */ });
...
function setDefaultColor(req, from) {
    getSavedBackgroundColor(from.origin, function (color) {
        if (color) {
...
function changeBackgroundColor(color) {
    chrome.tabs.insertCSS(null, { code: "* { background-color: ".concat(color || 'unset', " !important;color:black;font-weight: bolder !important; }") });
    // var script = `
