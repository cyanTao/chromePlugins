...
var contentScript = {
    ...
    getTable: function (req, callback) {
        if (callback === void 0) { callback = function (any) { }; }
        return __awaiter(this, void 0, void 0, function () {
            var table, arr, text;
            return __generator(this, function (_a) {
                table = document.querySelector('.table-section .el-table__body-wrapper');
                arr = Array.from($(table).find('tr'))
                    .map(function (item) {
                    var td = Array.from($(item).find('td'))
                        .slice(2, 5)
