...
$(window).on('load', function () {
    // 检查有没有要执行的队列
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.sendMessageToTabs)({ greeting: 'checkQueue' });
});
var moveEvent = windowMoveEvent();
var activeClassName = 'dom-active-style', hoverClassName = 'dom-hover-style';
var contentScript = {
    ...
    doJenkins: function (req, callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(req);
                alert(11);
    ...
    building: function (req, callback) {
        if (callback === void 0) { callback = function () { }; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(req);
...
function windowMoveEvent() {
    return lodash__WEBPACK_IMPORTED_MODULE_1__.debounce(function (e) {
        var key = 'domUniqueCode';
        var dom = $(e.target);
        // 非当前选中的一律去掉类名
        ...
        // dom生成唯一标识
        if (!dom.attr(key)) {
            var domUniqueCode = Date.now() + '-' + Math.random() * 100;
...
function windowClickEvent(e) {
    ...
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.sendMessageToTabs)({ greeting: 'setFormValue', value: getFormValues(e.target) });
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.sendMessageToTabs)({ greeting: 'catchForm', value: false });
}
function getFormValues(form) {
    ...
    dom.find('input').each(function () {
        ...
        var value = _this.val();
        var index = result.findIndex(function (item) { return item.name === name; });
        if (index !== -1) {
            var val = result[index].value;
